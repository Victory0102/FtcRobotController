...
export const STATUS_TONE: Record<string, 'healthy' | 'advisory' | 'warning' | 'missing' | 'disconnected'> = {
  'Stable': 'healthy',
  'Changed': 'advisory',
...
export function getStatusClass(s: string | null | undefined): string {
 ...
 */
export function notComparable(): string {
